      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Have questions about our encryption? Want to contribute to the project? 
          ...
          <div className="lg:col-span-1">
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Feedback & Questions</h3>
                  <p className="text-gray-600">
                    We're always looking to improve SecureChat. Share your thoughts and ideas with us.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Found a security issue? We appreciate responsible disclosure and will credit researchers.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Interested in collaborating or integrating SecureChat? Let's talk about opportunities.
                  </p>
                </div>
              </div>
            </div>
